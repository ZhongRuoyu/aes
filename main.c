...
void usage(const char *basename) {
    fprintf(stderr,
            ...
            "                  to an existing file with read access. <out> must be a valid \n"
            ...
            "                  file, which contains a valid hexadecimal string. The length \n"
            "                  of the key should be 128, 192, or 256 bits. The AES \n"
